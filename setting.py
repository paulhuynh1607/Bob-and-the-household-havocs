...
PLAYER_LEFT1 = "../assets/Entities/Bob/Animation/LeftWalkingAnimation/BobLefttWalking1.png"
PLAYER_LEFT2 = "../assets/Entities/Bob/Animation/LeftWalkingAnimation/BobLefttWalking2.png"
PLAYER_LEFT3 = "../assets/Entities/Bob/Animation/LeftWalkingAnimation/BobLefttWalking3.png"
PLAYER_LEFT4 = "../assets/Entities/Bob/Animation/LeftWalkingAnimation/BobLefttWalking4.png"
...
# Sound Effects
PLAYER_WALKING = pygame.mixer.Sound("../assets/Sounds/Effects/PlayerFootsteps.mp3")
PLAYER_WALKING.set_volume(1)
BOSS_WALKING = pygame.mixer.Sound("../assets/Sounds/Effects/BossFootSteps.mp3")
BOSS_WALKING.set_volume(1)
BUTTON_SOUND = pygame.mixer.Sound("../assets/Sounds/Effects/buttonsoundeffect.mp3.mp3")
BUTTON_SOUND.set_volume(1)
DEATH = pygame.mixer.Sound("../assets/Sounds/Effects/Death.mp3.mp3")
DEATH.set_volume(1)
FLASHBANG = pygame.mixer.Sound("../assets/Sounds/Effects/Flashbang.mp3")
DEATH.set_volume(1)
SPRAY = pygame.mixer.Sound("../assets/Sounds/Effects/Spray.mp3")
SPRAY.set_volume(1)
